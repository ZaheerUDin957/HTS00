...
class StreamlitApp:
    ...
    def main_bar(self, uploaded_files, text_content, text_splitter_name, chunk_size, chunk_overlap):
        st.title("Q/A with Your Files")
        ...
        # Embed text using TextEmbedder
        embeddings = self.text_embedder.embed_text(splitted_text)
    ...
    def sidebar(self):
        ...
        return uploaded_files, text_splitter_name, chunk_size, chunk_overlap

    def run(self):
        uploaded_files, text_splitter_name, chunk_size, chunk_overlap = self.sidebar()
        ...
        self.main_bar(uploaded_files, text_content, text_splitter_name, chunk_size, chunk_overlap)
